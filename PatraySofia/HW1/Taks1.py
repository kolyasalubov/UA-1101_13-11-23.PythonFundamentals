...
replaced_text = uppercase_text.replace("I", "&")

print("Number of occurrences of 'better':", count_better)
print("Number of occurrences of 'never':", count_never)
print("Number of occurrences of 'is':", count_is)
print("\nText in uppercase:\n", uppercase_text)
